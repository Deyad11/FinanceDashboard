...
const Header = ({ searchQuery, setSearchQuery, darkMode, setDarkMode, currentPage, setCurrentPage }) => {
  ...
  const handleTabClick = (tab) => {
    setActiveTab(tab)
    if (currentPage === 'insights') setCurrentPage('dashboard')
    track('tab_click', { tab })
  }
    ...
    <header className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 shrink-0 transition-colors">
      ...
      <div className="flex md:hidden items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-1.5 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
            <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
      ...
      <div className="hidden md:flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="p-1.5 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors">
            <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
              <path fillRule="evenodd" d="M10 2a6 6 0 00-6 6c0 1.887-.454 3.665-1.257 5.234a.75.75 0 00.515 1.076 32.91 32.91 0 003.256.508 3.5 3.5 0 006.972 0 32.903 32.903 0 003.256-.508.75.75 0 00.515-1.076A11.448 11.448 0 0116 8a6 6 0 00-6-6zM8.05 14.943a33.54 33.54 0 003.9 0 2 2 0 01-3.9 0z" clipRule="evenodd" />
            </svg>
          </button>
